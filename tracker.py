...
class tracker():
    ...
    def find_window_centroids(self,warped):
        ...
        window_height = self.window_height  # Break image into 9 vertical layers since image height is 720
        ...
        # return averaged values of the line centers, help tp keep the markers from jumping around too much
